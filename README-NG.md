...
3. Callbacks often execute on different threads. This imposes the need for careful handling of thread contexts during operation resumption—especially critical for applications running in environments like JEE or UI framework (JavaFX, Swing, etc).
